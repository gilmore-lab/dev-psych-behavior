...
Displays/Environment:  Task/Questionnaires - Method of response is not clear for most parts of study  
Measures:   
- Questionnaires  
  - Parent (1) The Family and Child Experiences Survey (FACES) 2009 cohort, Absenteeism (1 in person verbal question))  
  - Child (8 - 4 assessed at 2 timepoints)(Peabody Picture Vocabulary Test (child pointed), Woodcock–Johnson Letter Word Identification subscale, Woodcock–Johnson Spelling Word subscale, Woodcock– Johnson Applied Problems subscale)    
    - in person task (child pointed, identify letters, write letters, solve simple math problems)  
    - exact way that children identified letters and solved math problems is unknown  
   - If the child was spanish (2), also Simon Says and Art Show subscales of the Preschool Language Assessment Survey  (method of response is unknown)  
...
Recruitment:   
- Children - 1. from our laboratory database and 2. a local science museum in a Northeastern metropolitan area  
- Adult - from Mechanical Turk   
Context:  Location of Study not provided     
Measures:   
- Participant  
  - present photo then explanation for phenomena (9 physics or 9 biology)

...
- Questionnaires administered by interviewers  
  - Child (1) - 4 years (MSCA) verbal response  
...
- Child  
  - Questionnaire (1) 
    - paper questionnaire - response (pencil) - Grades 3-5 only  
    - role playing - dolls - Grades K-2 only  
  - Sorting Task (1) on Computer - response (button press)  
...
Measures:   
- In person Interview (1) - Verbal response   
...
Measures:
- View slideshow on laptop computer screen (watch and caregiver explain pictures)

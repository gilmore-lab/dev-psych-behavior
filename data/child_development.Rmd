...
|---|---|---|---|---|
| | McCarthy Scales of Children’s Abilities | Neuropsychological Assessment | Child | 4 Years |
| | Attention Deficit Hyperactivity Disorder Test | children’s ADHD difficulties | Mother | 4 Years |  
| |Exposure Assessment | Maternal age at child birth | Mother | first-trimester |
||Exposure Assessment|maternal parity at birth (primiparous, multiparous)|Mother|first-trimester|
||Exposure Assessment|Smoking status during pregnancy|Mother|first-trimester|
||Exposure Assessment|Breastfeeding duration|Mother|9 Months, 18 Months|
||Exposure Assessment|Maternal and Paternal Education|Mother| first-trimester, 4 Years|
||Exposure Assessment|maternal occupational status|Mother| first-trimester, 4 Years|
||Exposure Assessment|birth order| Mother| first-trimester, 4 Years|
||Exposure Assessment|maternal marital status | Mother| first-trimester, 4 Years|
||Exposure Assessment|child preschool attendance| Mother| 4 Years|
||Exposure Assessment|television watching during weekdays| Mother| 4 Years|
||Exposure Assessment|parental participation at leisure time during weekends| Mother| 4 Years|
||Clinical Records| Gestational age at delivery | Clinical Records | Birth|
||Clinical Records| anthropometric measurements at birth|| Clinical Records| Birth|
...
| Study | Tasks | Construct | Respondent | Timepoint (Age) |  
|---|---|---|---|---|
||Berlin Test of Fluid and Crystallized Intelligence|cognitive abilities|Student|pretest|
||Student Achievement test of national educational standards - Math |student achievement|Student|pretest|
||Student Achievement test of national educational standards - German |student achievement|Student|pretest|
||Intellectual Engagement |Ratings|Student|pretest + 41 days|
||Berlin Test of Fluid and Crystallized Intelligence|cognitive abilities|Student|post test|
||Student Achievement test of national educational standards - Math |student achievement|Student|post test|
||Student Achievement test of national educational standards - German |student achievement|Student|post test|
||School Grades - Math||School Grades|pretest|
||School Grades - German||School Grades|pretest|
||School Grades - Math||School Grades|post test|
||School Grades - German||School Grades|post test|
...
| Study | Tasks | Construct | Respondent | Timepoint (Age) |  
|---|---|---|---|---|
||The Family and Child Experiences Survey||Parent|Fall 2009, Spring 2010|
|| Absenteeism Question||Parent|Spring 2010|
...
| Study | Tasks | Construct | Respondent | Timepoint (Age) |  
|---|---|---|---|---|
||Paper Questionnaire|Self report assessment|Child|Grades 3-5 only|
...
||Child IAT|Sorting Task|Child| Grades K-5|
||School Records|absenteeism|Records|Grades K-5|
||School Records|year end report card|Records|Grades K-5|
